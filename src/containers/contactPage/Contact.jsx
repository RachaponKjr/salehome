            ...
            >
              ...
              >
                ...
                <Flex flexDirection={'column'} gap={4}>
                  ...
                  <Text>
                    34/6 หมู่ที่ 1 ถนนแจ้งวัฒนะ ตำบลคลองเกลือ <br />
                    ...
                    <Flex flexDirection={'column'} gap={4}>
                      ...
                      <Flex flexDirection={'column'} gap={3}>
                        ...
                        <Flex alignItems={'center'} gap={2}>
                          <FaPhoneAlt size={20} />
                          <Text ml={4}>081 642 7488</Text>
                        </Flex>
                        <Flex alignItems={'center'} gap={2}>
                          <GiRotaryPhone size={29} />
